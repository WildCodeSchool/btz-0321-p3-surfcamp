...
export default function CarouselProperty(): JSX.Element {
  ...
  function NextArrow({ onClick }: any): JSX.Element {
    return (
      <div className=" absolute -right-36 z-10 ">
  ...
  return (
    <div className="flex w-10/12 h-56 justify-center items-center relative ml-20 ">
      <Slider
        {...setting}
