    ...
    return(
        <div className="w-full bg-mainBlue text-white flex flex-col">
            ...
            <p className="w-full">Nos articles camps de surf sont reconnus par la communauté pour apporter 
               de réels conseils aux surfeurs désireux de voir le monde et de s’essayer à 
               l’expérience surf à l’étranger. Notre support est totalement gratuit et ne vise 
               qu’à vous aider au mieux dans la préparation de vos surf trips en France et à 
               l’étranger. Dans ce souci, nous nous plions en quatre pour vous
               apporter toutes les réponses à vos questions, et vous permettre de passer les 
               meilleurs séjours surf possibles ! Aloha !
            </p>
            </div>
            ...
            <div className="flex flex-col text-center lg:text-left">
                <h3 className="mb-6 text-lg font-bold text-center md:text-left">Société</h3>
                <a className="pb-2" href="#">Qui sommes nous ?</a>
                <a className="pb-2" href="#">Mentions légales</a>
                <a className="pb-2" href="#">Confidentialité</a>
            </div>
            ...
            <div className="flex flex-col">
                ...
                <a className="pb-2" href="#">Publicité</a>
                <a className="pb-2" href="#">A propos</a>
                <a className="pb-2" href="#">Contact</a>
            </div>
            </div>
